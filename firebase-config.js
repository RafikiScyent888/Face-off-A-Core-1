/* =====================================================================
   FIREBASE CONFIG  —  Face-off: A+ Core 1
   ---------------------------------------------------------------------
   ...
   game writes to its own namespace (this one uses rooms/core1-XXXX),
   so a A+ Core 1 room code can never collide with another game’s.
   ===================================================================== */
