...
3. Name it something like `faceoff-core1`. Click **Continue**.
...
5. You'll land on a screen showing a URL like
   `https://faceoff-core1-default-rtdb.firebaseio.com/` — that's your `databaseURL`.
...
3. App nickname: `faceoff-c1`. **Do not** check "Firebase Hosting". Click **Register app**.
...
const firebaseConfig = {
  ...
  authDomain: "faceoff-core1.firebaseapp.com",
  databaseURL: "https://faceoff-core1-default-rtdb.firebaseio.com",
  projectId: "faceoff-core1",
  storageBucket: "faceoff-core1.appspot.com",
