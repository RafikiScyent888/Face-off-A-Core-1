...
FirebaseTransport.prototype = {
  ...
  _basePath: function () { return 'rooms/core1-' + this.room; },
...
/* The deck remembers which clues have been used. It outlives a single
   ...
   editing questions-core1.js starts the memory over instead of pointing
...
function Launcher() {
  ...
  '<div class="launch"><div class="launch-inner">' +
    ...
    '<h1>FACE-OFF</h1>' +
    '<div class="sub">A+ Core 1 &nbsp;·&nbsp; 220-1201 &nbsp;·&nbsp; Team Review</div>' +
...
function Host(forcedCode) {
  ...
  function topbar() {
    return '<div class="topbar">' +
      ...
      '<div class="t2">A+ CORE 1 · 220-1201</div></div></div>' +
  ...
  function boardView() {
    ...
    if (!b.length) {
      return '<div class="wrap"><div class="card"><h2>No questions loaded</h2>' +
        '<div class="hint">Add categories to <span class="mono">questions-core1.js</span>.</div></div></div>';
    }
  ...
  function _render() {
    if (!P) {
      app.innerHTML = '<div class="play"><div class="card" style="text-align:center">' +
        '<div class="brand" style="justify-content:center"><div class="mark">⚔</div><div><div class="t1">FACE-OFF</div><div class="t2">A+ CORE 1</div></div></div>' +
