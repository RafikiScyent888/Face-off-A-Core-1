...
Everything lives in **`questions-core1.js`** — plain text, no code knowledge
...
questions**. Every 220-1201 objective from 1.1 to 5.6 is covered:

| Category | Objectives | Domain (exam weight) |
|---|---|---|
| Mobile Devices | 1.1, 1.2 | Mobile Devices (13%) |
| Ports & Protocols | 2.1 | Networking (23%) |
| Wireless & Internet | 2.2, 2.7 | Networking |
| Network Hardware & SOHO | 2.3–2.6, 2.8 | Networking |
| RAM & Storage | 3.1, 3.8 | Hardware (25%) |
| Motherboards, CPUs & Power | 3.4, 3.5 | Hardware |
| Cables & Displays | 3.2, 3.3 | Hardware |
| Printers | 3.6, 3.7 | Hardware |
| Virtualization & Cloud | 4.1, 4.2 | Virt. & Cloud (11%) |
| Troubleshooting: Hardware | 5.1, 5.2 | Troubleshooting (28%) |
| Troubleshooting: Display & Mobile | 5.3, 5.4 | Troubleshooting |
| Troubleshooting: Net & Print | 5.5, 5.6 | Troubleshooting |

Note this is the **220-1201 (V15)** objective list, not 220-1101 — CompTIA
restructured Core 1 for the 1200 series. Mobile Devices collapsed to two
objectives, storage moved to 3.8, and troubleshooting is now six objectives.
...
| `questions-core1.js` | **The question bank — this is the file you'll edit** |
